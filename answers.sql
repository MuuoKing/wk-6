...
-- 3. Remember to FLUSH PRIVILEGES; after user management operations in production
-- 4. Password policies should be enforced according to security requirements
